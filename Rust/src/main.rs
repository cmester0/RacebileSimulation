...
fn main() {
    ...
    let rtfm = HexMap {
        tiles: BTreeMap::from([
            ...
            // Loop
            (Coord::tri(-1,-6,1), Tile::new(vec![UL,DL]).forced()),
            (Coord::tri(-2,-6,1), Tile::new(vec![UL]).chikane()),
            ...
            (Coord::tri(-2,-6,0), Tile::new(vec![D])),
        ...
        players: vec![
            Player { position: Coord::tri(3,0,0), direction: DR, color: Color::RGB(255, 0, 0), radius: 0.2 },
            Player { position: Coord::tri(3,0,1), direction: DR, color: Color::RGB(0, 0, 255), radius: 0.3  },
            Player { position: Coord::tri(2,0,0), direction: DR, color: Color::RGB(0, 255, 0), radius: 0.4  },
            Player { position: Coord::tri(2,0,1), direction: DR, color: Color::RGB(255, 255, 0), radius: 0.5 },
            Player { position: Coord::tri(1,0,0), direction: DR, color: Color::RGB(255, 0, 255), radius: 0.6 },
            Player { position: Coord::tri(1,0,1), direction: DR, color: Color::RGB(0, 255, 255), radius: 0.7 },
            Player { position: Coord::tri(0,0,0), direction: DR, color: Color::RGB(255, 100, 100), radius: 0.8 },
            Player { position: Coord::tri(0,0,1), direction: DR, color: Color::RGB(100, 100, 255), radius: 0.9 },
        ],
    };
